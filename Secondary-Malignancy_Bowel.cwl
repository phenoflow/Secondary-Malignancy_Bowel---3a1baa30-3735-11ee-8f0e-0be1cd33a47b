...
steps:
  ...
  secondary-malignancy_bowel---primary:
    run: secondary-malignancy_bowel---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  secondary-malignancy_bowel-intestine---secondary:
    run: secondary-malignancy_bowel-intestine---secondary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: secondary-malignancy_bowel---primary/output
  output-cases:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: secondary-malignancy_bowel-intestine---secondary/output
class: Workflow
inputs:
  inputModule1:
    id: inputModule1
